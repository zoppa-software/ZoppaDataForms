    ...
    Public NotInheritable Class InitializationFile
        ...
        Public Structure ValueResult
            ...
            Public Function Convert(Of T)() As T
                Dim resType = GetType(T)
                If resType Is GetType(Byte()) Then
                    Return Me.Convert(Of T, Parameter.BinaryConverter)()
                ElseIf resType Is GetType(Byte) OrElse resType Is GetType(Byte?) Then
                    Return Me.Convert(Of T, Parameter.ByteConverter)()
                ElseIf resType Is GetType(Boolean) OrElse resType Is GetType(Boolean?) Then
                    Return Me.Convert(Of T, Parameter.BooleanConverter)()
                ElseIf resType Is GetType(Date) OrElse resType Is GetType(Date?) Then
                    Return Me.Convert(Of T, Parameter.DateConverter)()
                ElseIf resType Is GetType(Decimal) OrElse resType Is GetType(Decimal?) Then
                    Return Me.Convert(Of T, Parameter.DecimalConverter)()
                ElseIf resType Is GetType(Double) OrElse resType Is GetType(Double?) Then
                    Return Me.Convert(Of T, Parameter.DoubleConverter)()
                ElseIf resType Is GetType(Short) OrElse resType Is GetType(Short?) Then
                    Return Me.Convert(Of T, Parameter.ShortConverter)()
                ElseIf resType Is GetType(Integer) OrElse resType Is GetType(Integer?) Then
                    Return Me.Convert(Of T, Parameter.IntegerConverter)()
                ElseIf resType Is GetType(Long) OrElse resType Is GetType(Long?) Then
                    Return Me.Convert(Of T, Parameter.LongConverter)()
                ElseIf resType Is GetType(Single) OrElse resType Is GetType(Single?) Then
                    Return Me.Convert(Of T, Parameter.SingleConverter)()
                ElseIf resType Is GetType(String) Then
                    Return Me.Convert(Of T, Parameter.StringConverter)()
                ElseIf resType Is GetType(TimeSpan) OrElse resType Is GetType(TimeSpan?) Then
                    Return Me.Convert(Of T, Parameter.TimeConverter)()
                Else
                    Throw New InvalidCastException("指定の型に変換するコンバーターが用意されていません")
                End If
            End Function
